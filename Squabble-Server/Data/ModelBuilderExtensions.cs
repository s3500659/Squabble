    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            var client = new CommunicationIdentityClient(
                "endpoint=https://squabble-communication-service.communication.azure.com/;accesskey=i+rjCVXosX100n2EJh4pB+NrR8b4zdas4zCDUnjUcINFlW5YJjpOlfxACsOqqpDYct91FXG8ZhilIM6ctEbwsg==");
        ...
        private static void LoadFriends(ModelBuilder modelBuilder)
        {
        ...
        private static void LoadUsersAsync(ModelBuilder modelBuilder, CommunicationIdentityClient _client)
        {
            var users = new[]
            {
                new User
                {
                    ...
                    CommunicationUserId =
                        "8:acs:025fbc48-8ea1-4cb2-959c-42b4dc9e9728_0000000d-dd08-d138-4bfe-953a0d009270"
                },
                new User
                {
                    UserName = "Hayzeus",
                    ...
                    CommunicationUserId =
                        "8:acs:025fbc48-8ea1-4cb2-959c-42b4dc9e9728_0000000d-dd09-72eb-4bfe-953a0d00927a"
                },
                new User
                {
                    UserName = "Handyman",
                    ...
                    CommunicationUserId =
                        "8:acs:025fbc48-8ea1-4cb2-959c-42b4dc9e9728_0000000d-dd09-bd2d-4bfe-953a0d00927c"
                },
                new User
                {
                    UserName = "Spongebob",
                    ...
                    CommunicationUserId =
                        "8:acs:025fbc48-8ea1-4cb2-959c-42b4dc9e9728_0000000d-dd0a-09f2-4bfe-953a0d009280"
                },
                new User
                {
                    UserName = "Squidward",
                    ...
                    CommunicationUserId =
                        "8:acs:025fbc48-8ea1-4cb2-959c-42b4dc9e9728_0000000d-dd0a-46ba-4bfe-953a0d009282"
                }
            };

            foreach (var user in users)
            {
                IEnumerable<CommunicationTokenScope> scope = new[]
                    { CommunicationTokenScope.Chat, CommunicationTokenScope.VoIP };
        ...
        private static void LoadLogins(ModelBuilder modelBuilder)
        {
        ...
        private static void LoadGroups(ModelBuilder modelBuilder)
        {
        ...
        private static void LoadGroupAdmins(ModelBuilder modelBuilder)
        {
        ...
        private static void LoadGroupChannels(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Channel>().HasData(
                new Channel
                {
        ...
        private static void LoadPosts(ModelBuilder modelBuilder)
        {
            // TODO
        }
    }
