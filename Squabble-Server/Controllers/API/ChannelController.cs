...
namespace Squabble.Controllers.API
{
    ...
    public class ChannelController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("[action]/{id}")]
        public async Task<Channel> GetByThreadId(string id) => await _channelManager.GetByThreadId(id);
        ...
        // some initial error checks to avoid querying the db if bad requests
        [HttpPost]
        [Route("[action]")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        ...
        [Route("[action]/{id}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        public async Task<List<ChannelMemberInfo>> GetMemberAcsIds(int id) => await _channelManager.GetMemberAcsIds(id);
